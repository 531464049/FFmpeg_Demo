...
//                                mVocalMixerNode  mAccMixerNode
//    mPlayerNode mSplitterNode                                        mPlayerIONode
//                                mAccMixerNode
    
    AUGraphConnectNodeInput(mPlayerGraph, mSplitterNode, 0, mVocalMixerNode, 0);
    AUGraphConnectNodeInput(mPlayerGraph, mVocalMixerNode, 0, mAccMixerNode, 0);
    
    AUGraphConnectNodeInput(mPlayerGraph, mSplitterNode, 1, mAccMixerNode, 1);
